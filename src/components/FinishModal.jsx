  ...
  return (
    <>
      <div className="fixed left-0 top-0 right-0 bottom-0 bg-[rgba(0,0,0,0.5)] flex items-center justify-center">
        <div className="flex flex-col gap-2 w-[90%] p-6 pt-8 bg-[#F2F2F2] rounded-[10px] justify-center items-center md:mx-[57px] md:px-[56px] lg:w-[40%] lg:pt-[51px] lg:pb-[69px]">
          <span className="text-[#152938] text-center text-2xl font-bold lg:text-[48px] lg:pb-[16px]">
            You did it!
          </span>
